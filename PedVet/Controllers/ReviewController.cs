...
{   
    ...
    public class ReviewController : Controller
    {
        ...
        public IActionResult GetPet(int reviewId)
        {
        ...
        [ProducesResponseType(200, Type = typeof(Review))]
        [ProducesResponseType(400)]
        public IActionResult GetReviewsForAPet(int petId)
        {
            var reviews = _mapper.Map<List<ReviewDto>>(_reviewRepository.GetReviewsOfAPet(petId));
        ...
        public IActionResult CreateReview([FromQuery] int reviewerId, [FromQuery] int pokeId, [FromBody] ReviewDto reviewCreate)
        {
            ...
            reviewMap.Pet = _petRepository.GetPet(pokeId);
